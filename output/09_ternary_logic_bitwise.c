...
int main(void) {
    ...
    neb_add_value("mx", mx);
    int both = ((x < y) && (y > 0));
    int either = ((x > 100) || (y == 8));
    int b_and = (x & y);
    neb_add_value("b_and", b_and);
    int b_or = (x | y);
    neb_add_value("b_or", b_or);
    int b_xor = (x ^ y);
    neb_add_value("b_xor", b_xor);
    printf("%s", "mx:");
    printf("\n");
    printf("%d", (int)mx);
    printf("\n");
    printf("%s", "both:");
    printf("\n");
    printf("%s", (both) ? "true" : "false");
    printf("\n");
    printf("%s", "either:");
    printf("\n");
    printf("%s", (either) ? "true" : "false");
    printf("\n");
    printf("%s", "bitwise and/or/xor:");
    printf("\n");
    printf("%d", (int)b_and);
    printf("\n");
    printf("%d", (int)b_or);
