...
int main(void) {
    printf("%s", "even(10):");
    printf("\n");
    printf("%s", (even(10)) ? "true" : "false");
    printf("\n");
    printf("%s", "odd(11):");
    printf("\n");
    printf("%s", (odd(11)) ? "true" : "false");
    printf("\n");
    printf("%s", "factorial(6):");
    printf("\n");
    printf("%d", (int)factorial(6));
    printf("\n");
    printf("%s", "prime(29):");
    printf("\n");
    printf("%s", (prime(29)) ? "true" : "false");
    printf("\n");
    printf("%s", "palindrome(level):");
    printf("\n");
    printf("%s", (palindrome("level")) ? "true" : "false");
    printf("\n");
    printf("%s", "leap_year(2024):");
    printf("\n");
    printf("%s", (leap_year(2024)) ? "true" : "false");
    printf("\n");
    printf("%s", "power(3, 4):");
    printf("\n");
    printf("%g", (double)power(3, 4));
    printf("\n");
    double angle = 30;
    printf("%s", "sin(30):");
    printf("\n");
    printf("%g", (double)neb_sin_deg(angle));
    printf("\n");
    printf("%s", "cos(30):");
    printf("\n");
    printf("%g", (double)neb_cos_deg(angle));
    printf("\n");
    printf("%s", "tan(30):");
    printf("\n");
    printf("%g", (double)neb_tan_deg(angle));
    printf("\n");
    return 0;
}
