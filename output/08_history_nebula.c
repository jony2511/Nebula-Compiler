...
int main(void) {
    ...
    (a = (a * 2));
    neb_add_value("a", a);
    printf("%d", (int)nebula_observe_current("a", 0));
    printf("\n");
    printf("%d", (int)nebula_observe_current("a", 1));
    printf("\n");
    printf("%d", (int)nebula_observe_current("a", 2));
    printf("\n");
    printf("%d", (int)nebula_observe_current("x", 1));
    printf("\n");
    return 0;
}
