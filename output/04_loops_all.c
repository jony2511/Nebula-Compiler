...
int main(void) {
    ...
    neb_add_value("i", i);
    int sum_while = 0;
    neb_add_value("sum_while", sum_while);
    while ((i <= 3))     {
    ...
    printf("%s", "sum_while:");
    printf("\n");
    printf("%d", (int)sum_while);
    printf("\n");
    int j = 0;
    neb_add_value("j", j);
    int sum_do = 0;
    neb_add_value("sum_do", sum_do);
    do     {
        (sum_do = (sum_do + j));
        neb_add_value("sum_do", sum_do);
        (j = (j + 1));
    ...
    printf("%s", "sum_for:");
    printf("\n");
    printf("%d", (int)sum_for);
    printf("\n");
    int t = 0;
    neb_add_value("t", t);
    int sum_loop = 0;
    neb_add_value("sum_loop", sum_loop);
    for ((t = 1); (t <= 3); (t = (t + 1)))     {
        (sum_loop = (sum_loop + t));
        neb_add_value("sum_loop", sum_loop);
    }
